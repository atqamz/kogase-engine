...
namespace KogaseEngine.Infra.Migrations
{
    ...
    [Migration("20250304165141_InitialCreate")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("KogaseEngine.Domain.Entities.Telemetry.EventDefinition", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("KogaseEngine.Domain.Entities.Telemetry.MetricAggregate", b =>
                {
                    ...
                    b.HasIndex("ProjectId", "MetricName", "Dimension", "DimensionValue", "Timestamp", "Period")
                        .IsUnique();
            ...
            modelBuilder.Entity("KogaseEngine.Domain.Entities.Telemetry.PlaySession", b =>
                {
                    ...
                    b.Property<string>("SessionProperties")
                        .IsRequired()
                        .HasColumnType("text");
            ...
            modelBuilder.Entity("KogaseEngine.Domain.Entities.Telemetry.TelemetryEvent", b =>
                {
                    b.HasOne("KogaseEngine.Domain.Entities.Telemetry.PlaySession", "Session")
                        .WithMany("Events")
